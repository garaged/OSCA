...
- M8.1 paper evaluation contracts: 30168661041
...
Live execution, real-capital orders, broker/exchange adapters, ML, LLM, F4 fidelity, provider production promotion, and external delivery-provider execution are not part of M8.
