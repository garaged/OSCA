...
- Candidate provider parsers use injected I/O. Live transports and production visibility remain blocked until licensing, credential, endpoint, quota, and failure controls are accepted.
