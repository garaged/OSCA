...
Define the accepted M3 temporal correctness semantics for approved intervals, UTC bar windows, stock exchange sessions, crypto UTC boundaries, completed bars, calendar-aware gaps, resampling lineage, interval-aware dataset identity, governed OHLCV payloads, and non-daily publication.
