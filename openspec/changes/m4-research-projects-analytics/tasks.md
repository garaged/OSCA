# Tasks — M4 research projects, analytics, and visualization

- [x] Verify M4 starts from the post-M3 main baseline.
- [x] Create `agent/m4-research-projects-analytics` from `main`.
- [x] Add M4 intent, scope, evidence plan, execution plan, and risk register.
