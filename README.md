...
The M0 architecture foundation, M0.x operational controls, M1 secure walking skeleton, M2 governed daily-data vertical slice, M3 multi-timeframe temporal correctness, M4 research projects analytics foundation, M5 independent extension packaging foundation, and M6 backtesting and strategy validation foundation are authoritative. M7 F2 event-driven validation is in progress. Later product scope requires a new governed milestone intent.
