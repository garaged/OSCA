...
- M7 intent, scope, acceptance criteria, evidence plan, execution plan, risk register, and deferred scope.
- M7 requirement allocation REQ-0093 through REQ-0101.
...
- Forward paper accounts, runtime strategy execution, persistence, ML, LLM, live execution, and provider production promotion.
