...
- **Baseline:** Completed M6 backtesting and strategy validation foundation
...
M7 starts from M6 request, execution-plan, and simulated order-intent contracts. It adds deterministic F2 event-driven validation contracts and services before introducing forward paper accounts or automation.
