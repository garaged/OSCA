...
| OpenSpec strict validation | Verify accepted P1 specification shape. | Pending hosted Quality |
| Manual testing update | Preserve operator smoke checklist for provider promotion behavior. | Implemented |
| Exit review | Retain residual deferred scope and validation evidence. | Pending hosted Quality |
