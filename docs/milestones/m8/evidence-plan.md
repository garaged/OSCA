...
- Prove that F3 paper evaluation depends on approved F2 promotion evidence.
- Prove that paper account and run identities are stable and independent.
...
| Slice | Evidence |
|---|---|
| M8.1 | Contracts, services, tests, ADR, requirements, OpenSpec, and foundation evidence. |
