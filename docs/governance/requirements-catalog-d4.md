...
| REQ-0316 | Asset, alias, watchlist, membership, and ordering writes shall be transactional and protected by profile compatibility and locking. | Transaction, rollback, migration, and contention tests |
...
| REQ-0319 | React and Rust shall gain no generic database, filesystem, network, secret, brokerage, or order authority. | Architecture and source-boundary tests |
...
| REQ-0324 | D4 exit shall retain automated, migration, performance, accessibility, supported-platform manual, traceability, and exit-review evidence. | Exit review |
