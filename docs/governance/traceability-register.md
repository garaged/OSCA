...
| Requirements | Authority | Intent | Specification | Acceptance criteria | Evidence plan | Documentation | ADRs | Status |
|---|---|---|---|---|---|---|---|---|
| REQ-0191-REQ-0197 | P5 intent; ADR-0043 | [P5 milestone](../milestones/p5/README.md) | [P5 State Reconciliation and Operator Surface](../specifications/p5-state-reconciliation-operator-surface.md) | [P5 acceptance](../milestones/p5/README.md#acceptance-criteria) | [P5 evidence](../milestones/p5/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Verified |
| REQ-0198-REQ-0204 | P6 intent; ADR-0043 | [P6 milestone](../milestones/p6/README.md) | [P6 No-Cost Local OHLCV Import Provider](../specifications/p6-local-ohlcv-import-provider.md) | [P6 acceptance](../milestones/p6/README.md#acceptance-criteria) | [P6 evidence](../milestones/p6/README.md#validation-gates); `src/osca/local_data_import/*`; `src/osca/bootstrap/cli.py`; `tests/test_p6_local_ohlcv_import.py`; PR #42 hosted Quality | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Verified |
| REQ-0205-REQ-0211 | P7 intent; ADR-0043 | [P7 milestone](../milestones/p7/README.md) | [P7 First Demo Research Workflow](../specifications/p7-demo-research-workflow.md) | [P7 acceptance](../milestones/p7/README.md#acceptance-criteria) | [P7 evidence](../milestones/p7/README.md#validation-gates); `src/osca/demo_research/*`; `src/osca/bootstrap/cli.py`; `tests/test_p7_demo_research_workflow.py`; PR #43 hosted Quality | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Verified |
| REQ-0212-REQ-0218 | P8 intent; ADR-0043 | [P8 milestone](../milestones/p8/README.md) | [P8 Backtest-to-Paper Happy Path](../specifications/p8-backtest-paper-happy-path.md) | [P8 acceptance](../milestones/p8/README.md#acceptance-criteria) | [P8 evidence](../milestones/p8/README.md#validation-gates); `src/osca/backtest_paper/*`; `src/osca/bootstrap/cli.py`; `tests/test_p8_backtest_paper_happy_path.py` | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Implementation candidate |
| REQ-0219-REQ-0225 | P9 intent; ADR-0043 | [P9 milestone](../milestones/p9/README.md) | [P9 SEC/FRED Live Preview Adapters](../specifications/p9-sec-fred-live-preview-adapters.md) | [P9 acceptance](../milestones/p9/README.md#acceptance-criteria) | [P9 evidence](../milestones/p9/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0226-REQ-0232 | P10 intent; ADR-0043 | [P10 milestone](../milestones/p10/README.md) | [P10 Runtime Provider Routing](../specifications/p10-runtime-provider-routing.md) | [P10 acceptance](../milestones/p10/README.md#acceptance-criteria) | [P10 evidence](../milestones/p10/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0233-REQ-0239 | P11 intent; ADR-0043 | [P11 milestone](../milestones/p11/README.md) | [P11 Useful Analyst Workspace](../specifications/p11-analyst-workspace.md) | [P11 acceptance](../milestones/p11/README.md#acceptance-criteria) | [P11 evidence](../milestones/p11/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0240-REQ-0246 | P12 intent; ADR-0043 | [P12 milestone](../milestones/p12/README.md) | [P12 ML/LLM Runtime Preview](../specifications/p12-ml-llm-runtime-preview.md) | [P12 acceptance](../milestones/p12/README.md#acceptance-criteria) | [P12 evidence](../milestones/p12/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0247-REQ-0253 | P13 intent; ADR-0043 | [P13 milestone](../milestones/p13/README.md) | [P13 Production Provider Promotion and Ingestion](../specifications/p13-production-provider-promotion-ingestion.md) | [P13 acceptance](../milestones/p13/README.md#acceptance-criteria) | [P13 evidence](../milestones/p13/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0254-REQ-0260 | P14 intent; ADR-0043 | [P14 milestone](../milestones/p14/README.md) | [P14 Production Operations](../specifications/p14-production-operations.md) | [P14 acceptance](../milestones/p14/README.md#acceptance-criteria) | [P14 evidence](../milestones/p14/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0261-REQ-0267 | P15 intent; ADR-0043 | [P15 milestone](../milestones/p15/README.md) | [P15 Runtime Extensions and Packs](../specifications/p15-runtime-extensions-packs.md) | [P15 acceptance](../milestones/p15/README.md#acceptance-criteria) | [P15 evidence](../milestones/p15/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0268-REQ-0274 | P16 intent; ADR-0043 | [P16 milestone](../milestones/p16/README.md) | [P16 Live-Order Readiness Study](../specifications/p16-live-order-readiness-study.md) | [P16 acceptance](../milestones/p16/README.md#acceptance-criteria) | [P16 evidence](../milestones/p16/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
| REQ-0275-REQ-0281 | P17 intent; ADR-0043 | [P17 milestone](../milestones/p17/README.md) | [P17 Real-Money Controlled Pilot](../specifications/p17-real-money-controlled-pilot.md) | [P17 acceptance](../milestones/p17/README.md#acceptance-criteria) | [P17 evidence](../milestones/p17/README.md#validation-gates) | [Manual testing and usage](../testing/manual-testing.md) | ADR-0043 | Planned |
