...
| REQ-0019, REQ-0020 | Cited PRD sections and D-records in requirements catalog | [M1 intent](../milestones/m1/intent.md) | [Secure walking skeleton](../specifications/m1-secure-walking-skeleton.md) | M1-AC-001, M1-AC-003, M1-AC-018, M1-AC-020 | M1.7 retained evidence pending final validated revision | [Run and operate M1](../milestones/m1/operations-guide.md) | ADR-0001, ADR-0004, ADR-0005, ADR-0009, ADR-0010 | In progress |
